...
use crate::vulkan::{Buffer, Renderer};

pub struct MeshManager {
	pub frame_data_descriptor_set_layout: vk::DescriptorSetLayout,
	pub instance_data_descriptor_set_layout: vk::DescriptorSetLayout,
	pub pipeline_layout: vk::PipelineLayout,
	pub basic_pipeline: vk::Pipeline,
	pub normal_pipeline: vk::Pipeline,
	pub lambert_pipeline: vk::Pipeline,
	pub static_basic_descriptor_set: vk::DescriptorSet,
	pub static_normal_descriptor_set: vk::DescriptorSet,
	pub static_lambert_descriptor_set: vk::DescriptorSet,
...
impl MeshManager {
	pub fn new(logical_device: &ash::Device, extent: vk::Extent2D, render_pass: vk::RenderPass, descriptor_pool: vk::DescriptorPool) -> Self {
		let frame_data_descriptor_set_layout = Self::create_frame_data_descriptor_set_layout(logical_device);
		let instance_data_descriptor_set_layout = Self::create_instance_data_descriptor_set_layout(logical_device);

		let pipeline_layout = Self::create_pipeline_layout(logical_device, frame_data_descriptor_set_layout, instance_data_descriptor_set_layout);
		let pipelines = Self::create_pipelines(logical_device, extent, pipeline_layout, render_pass);
		let descriptor_sets = Self::create_static_descriptor_sets(logical_device, descriptor_pool, instance_data_descriptor_set_layout);
	...
	fn create_frame_data_descriptor_set_layout(logical_device: &ash::Device) -> vk::DescriptorSetLayout {
	...
	fn create_instance_data_descriptor_set_layout(logical_device: &ash::Device) -> vk::DescriptorSetLayout {
		let layout_binding = vk::DescriptorSetLayoutBinding::builder()
			.binding(0)
	...
	fn create_pipelines(logical_device: &ash::Device, extent: vk::Extent2D, pipeline_layout: vk::PipelineLayout, render_pass: vk::RenderPass) -> Vec<vk::Pipeline> {
		// Shared
	...
	fn create_static_descriptor_sets(logical_device: &ash::Device, descriptor_pool: vk::DescriptorPool, instance_data_descriptor_set_layout: vk::DescriptorSetLayout) -> Vec<vk::DescriptorSet> {
	...
	pub fn handle_resize(&mut self, logical_device: &ash::Device, extent: vk::Extent2D, render_pass: vk::RenderPass) {
		...
		let pipelines = Self::create_pipelines(logical_device, extent, self.pipeline_layout, render_pass);
